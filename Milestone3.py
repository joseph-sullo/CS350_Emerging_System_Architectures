...
class CWMachine(StateMachine):
    ...
    def on_enter_dot(self):
        ...
        self.redLight.blink(on_time = 0.5, off_time = 0.5, n = 1, background = True)
    ...
    def on_enter_dash(self):
        ...
        self.blueLight.blink(on_time = 1.5, off_time = 1.5, n = 1, background = True)
    ...
    def transmit(self):
        ...
        while not self.endTransmission:
            ...
            for word in wordList:
                ...
                if(word != ""):     #Use this to add a 3000ms pause between iterations of the loop
                #if(wordsCounter < lenWords):      #Use this for the same functionality as previous Counter if statements
                    self.send("doWP")
                    self.send("doWP")
                    wordsCounter +=1
