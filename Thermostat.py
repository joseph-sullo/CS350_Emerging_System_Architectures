...
class TemperatureMachine(StateMachine):
    ...
    def setupSerialOutput(self):
        output = f"State: {self.current_state.id}, Set point: {self.setPoint}F, Temp: {floor(self.getFahrenheit())}F"
